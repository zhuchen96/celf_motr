...
class Detector(object):
    ...
    def detect(self, prob_threshold=0.6, area_threshold=100, proposal_threshold=0.05, vis=False):
        ...
        for i, data in enumerate(tqdm(loader)):
            ...
            proposals, memory, spatial_shapes, level_start_index, valid_ratios, mask_flatten = self.detr.inference_single_image_proposals_light_light(cur_img, (seq_h, seq_w), score_threshold=proposal_threshold)
            res = self.detr.inference_single_image_light_light(cur_img, (seq_h, seq_w), track_instances, proposals, memory, spatial_shapes, level_start_index, valid_ratios, mask_flatten)
...
if __name__ == '__main__':
    ...
    args = apply_checkpoint_model_args(args, checkpoint, context='ablation/submit_dance_light')

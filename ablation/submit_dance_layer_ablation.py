...
class Detector(object):
    ...
    def detect(self, prob_threshold=0.6, area_threshold=100, proposal_threshold=0.05, layer=5, vis=False):
        total_dts = 0
        ...
        for i, data in enumerate(tqdm(loader)):
            ...
            proposals = self.detr.inference_single_image_proposals_light(cur_img, (seq_h, seq_w), score_threshold=proposal_threshold, layer=layer)
...
if __name__ == '__main__':
    ...
    args = apply_checkpoint_model_args(args, checkpoint, context='ablation/submit_dance_layer_ablation')
    ...
    for vid in vids:
        ...
        det.detect(args.score_threshold, proposal_threshold=args.proposal_threshold, layer=args.layer)

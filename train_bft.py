...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch_mot_self_proposal(
            model, criterion, criterion_detect, data_loader_train, optimizer, args.score_threshold,
            device, epoch, args.clip_max_norm, args.accum_iter, args.lambda_detect,
            args.reuse_encoder_cache)
        lr_scheduler.step()
        if args.output_dir:

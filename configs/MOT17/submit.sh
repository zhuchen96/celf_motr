...
CHECKPOINT=/work/scratch/guelhan/Publikation/checkpoints/selfmotr_mot17.pth
TIMESTAMP=$(date +'%Y%m%d_%H%M%S')
EXP_DIR=/work/scratch/guelhan/publ_test/submit/${TIMESTAMP}
mkdir -p ${EXP_DIR}
LOG_DIR=${EXP_DIR}/logs
mkdir -p ${LOG_DIR}
LOG_FILE=${LOG_DIR}/submit.log

python3 submit_mot17.py \

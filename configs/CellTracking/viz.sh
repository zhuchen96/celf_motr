...
#
# Usage:
#   bash configs/CellTracking/viz.sh
#
# Override YAML values on the command line:
#   bash configs/CellTracking/viz.sh --div_threshold 0.4
#   bash configs/CellTracking/viz.sh --fps 15 --scale 10
#   bash configs/CellTracking/viz.sh --resume outputs/cell_moma/checkpoint0009.pth
# ============================================================
set -e
...
python3 viz_cell.py --config "${CONFIG}" "$@"

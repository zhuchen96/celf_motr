...
PRETRAIN=/work/scratch/guelhan/Publikation/checkpoints/selfmotr_dance.pth
TIMESTAMP=$(date +'%Y%m%d_%H%M%S')
EXP_DIR=/work/scratch/guelhan/publ_test/eval_detect_no/${TIMESTAMP}
mkdir -p ${EXP_DIR}
LOG_DIR=${EXP_DIR}/logs
mkdir -p ${LOG_DIR}
LOG_FILE=${LOG_DIR}/eval.log

python3 eval_detect_no_trackquery.py \

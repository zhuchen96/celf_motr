...
if __name__ == '__main__':
    tracker_folder = "/work/scratch/mededovic/selfmotr/SelfMOTR_Pilot_Henning/logs/d/tracker"
    gt_folder = "/images/SegmentationDistillation/data/DanceTrack/val"
    output_folder = "/work/scratch/mededovic/selfmotr/SelfMOTR_Pilot_Henning/out"
    seqmap = "/images/SegmentationDistillation/data/DanceTrack/val_seqmap.txt"
    d = track_eval(tracker_folder, gt_folder, output_folder, seqmap)

    print("IDF1: {:.3f}, HOTA: {:.3f}, MOTA: {:.3f}, ASSA: {:.3f}, DETA: {:.3f}, IDSW: {}".format(d["IDF1"], d["HOTA"], d["MOTA"], d["ASSA"], d["DETA"], d["IDSW"]))
